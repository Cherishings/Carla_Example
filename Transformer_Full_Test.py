...
class VehicleTransformerMAnet(nn.Module):
    def __init__(self, num_waypoints=30, d_model=128, nhead=8, num_layers=3):
...
# Model Load
# ----------------------------
model_path = "/home/ali_carla/Desktop/Ali/Leader_Board_2/CARLA_Leaderboard_2.0/CARLA_Leaderboard_20/PythonAPI/examples/Transformer_Full_result_20250802_105136/transformer_corrected_VehicleNNController_NAG.pth"
